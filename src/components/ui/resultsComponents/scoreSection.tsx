...
export function ScoreSection() {
  ...
  return (
    <div className="bg-background mb-4 md:mb-10 border-1 border-gray-800/10  rounded-xl p-2 md:p-6 flex md:flex-row flex-col shadow-sm">
      ...
      <div className="flex flex-col gap-4 p-2 md:p-6 rounded-xl md:ml-4 max-w-3xl">
        <span className="md:text-3xl text-xl font-bold py-1 px-1 rounded-md tracking-wide text-zinc-700">
          {score === 100
        ...
        <div className=" text-gray-900 bg-white p-5 rounded-lg leading-relaxed shadow-xs border border-zinc-300/40">
