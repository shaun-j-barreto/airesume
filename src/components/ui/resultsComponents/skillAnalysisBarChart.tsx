...
export default function SkillAnalysisBarChart() {
  ...
  return (
    <div className="relative w-full h-[550px] border-1 border-gray-800/10 bg-background hover:bg-orange-50/60 transition ease-in-out duration-400 shadow-sm rounded-xl p-4">
