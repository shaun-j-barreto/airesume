...
export const ModalTrigger = ({
  ...
  return (
    <button
      className={cn(
        "px-8 py-2 rounded-md text-black dark:text-white text-center relative overflow-hidden",
        className
      )}
  ...
  return (
    ...
    >
      <svg
        ...
        className="text-black cursor-pointer bg-purple-300 h-6 w-6 group-hover:scale-125 rounded-full p-0.5  transition duration-200"
      >
